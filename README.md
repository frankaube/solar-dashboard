...
**Canadian net metering, modelled properly.** Credits bank 1:1 and expire on 31 March.
Sales tax applies to what you buy back but not to what you export, so a kilowatt-hour
you use yourself is worth about 15% more than one you sell. A dashboard that ignores
this overstates the value of export every single day.
...
- **Banked export credits and when they expire** — refusing to project a trend until
  there is enough history to support one.
