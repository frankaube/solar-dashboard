    ...
    */
    ...
    const period = (wh: number): SavingsPeriod => {
      ...
      return {
        ...
        // The demo house has a whole-home meter by construction, so all of its production
        // is measured. Zero would make every demo period read as an estimate.
        measuredProducedKwh: r1(producedKwh),
