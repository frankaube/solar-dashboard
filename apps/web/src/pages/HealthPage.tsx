      ...
      */}
      ...
      <Collapse in={showHistory}>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          ...
          {/*
            Beside the notification log rather than in the headline. It is history, and it
            renders nothing at all until the machine has actually had to repair itself —
            which on a healthy install is never.
          */}
          <RecoveryCard />
          <NotificationLog />
          {resolved.length > 0 && (
