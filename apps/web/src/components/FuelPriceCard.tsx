  ...
  return (
    <Surface title="Petrol comparison">
      <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
        The Car page prices your driving against the petrol it did not burn. Each drive uses
        the published average for the month it happened in, not today&rsquo;s price — over
        the last eighteen months that figure has moved by nearly half.
      </Typography>
