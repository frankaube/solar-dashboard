...
/**
 * The installer's version, and the only place it is written down.
 *
 * Inno compares this against the installed copy to decide what an upgrade means, so
 * it has to move when a build goes out. The api package version tracks the library,
 * not the shipped product, which is why this is separate.
 */
const VERSION = '0.9.0';
